...
namespace Blog.Service.Helpers.Describers
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        public override IdentityError PasswordRequiresUniqueChars(int uniqueChars)
        {
            return new IdentityError{ Code = "PasswordReqireUniqueChars", Description = $"En az {uniqueChars} farklı karakter içermelidir." };
        }
